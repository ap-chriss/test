...
////////////////////////////// INCLUDES //////////////////////////////
    ...
    #include "Min_Primitives.h" // Graphic primitives layer
...
/*********************************************************************
* Macros: RGB888CONVERT(red, green, blue)
*
* Overview: Converts true color into 8:8:8 RGB format.
*
* PreCondition: none
*
* Input: Red, Green, Blue components.
*
* Output: 8 bits red, 8 bits green, 8 bits blue color.
*
* Side Effects: none
*
********************************************************************/

    #define RGB888CONVERT(red, green, blue) (DWORD) ((red << 16) | (green << 8) | (blue))

...
typedef struct
{
    ...
    #ifdef USE_GRADIENT
    WORD   ColorGradient;       //Color to transition to
    WORD   GradientType;        //Type of transition
    #endif
...
extern WORD     _rpnlGradientColor;  // Color of Gradient
extern WORD     _rpnlGradientType;   // Type of Gradient
